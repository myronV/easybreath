...
$products_list = array(
    1 => array(
            'product_id' => '11',    //код товара (из каталога CRM)
            'price'      => '1299', //цена товара 1
...
$data = array(
    ...
    'comment'         => $_GET['product'],    // комментарий
...
<html lang="ru">
    <head>
        <meta charset="UTF-8">
        <link rel="shortcut icon" href="img/waterbreath-favicon.ico" type="image/x-icon">
        ...
        <div class="block_success">
            ...
            <div class="success">
                <ul class="list_info">
	                ...
	                <li><span>Заказ: </span><span id="product" style="display:initial"><?=$_GET['product']?></span></li>
                </ul>

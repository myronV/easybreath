...
$subject = 'Заказ товара - EasyBreath'; // заголовок письма
$addressat = "kupi2008@ukr.net"; // Ваш Электронный адрес
$success_url = './easybreath.php?name='.$_POST['name'].'&phone='.$_POST['phone'].'&time='.$_POST['Время_звонка'].'&product='.$_POST['product'];
